package {
	...
	public class MeterBar_health extends MeterBar{
		...
		private var color_lo:uint = 0xDD0000;
		private var color_mid:uint = 0xDDAA00;
		private var color_hi:uint = 0x00DD00;
		private var color_curr:uint = color_hi;
		private const _demo:Boolean = false;
		
		public function MeterBar_health(){
			setAmounts(50,100);
			if(_demo)
