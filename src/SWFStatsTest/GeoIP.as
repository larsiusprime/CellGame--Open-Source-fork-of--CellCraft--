package SWFStatsTest
{
	...
	public class GeoIP
	{
		...
		{
			Log.Output("SWFStatsTest.GeoIP.Lookup  CALLBACK '" + callback + "'");
			...
			sendaction.load(new URLRequest("http://utils.SWFStatsTest.com/geoip/Lookup.aspx?swfid=" + Log.SWFID + "&guid=" + Log.GUID));
		}
		...
		{
			Log.Output("SWFStatsTest.GeoIP.LookupFinished");	
		...
		{
			Log.Output("** ERROR COMPLETING REQUEST ~ SWFStatsTest.GeoIP **");
		}
