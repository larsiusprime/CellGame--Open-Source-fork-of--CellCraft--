package SWFStatsTest
{
	...
	public final class Log
	{
		...
		// ------------------------------------------------------------------------------
		// View
		// Logs a view and initialises the SWFStatsTest API
		// ------------------------------------------------------------------------------
		public static function View(swfid:int = 0, guid:String = "", defaulturl:String = ""):void
		{
			...
			Security.allowDomain("http://tracker.SWFStatsTest.com/");
			Security.allowInsecureDomain("http://tracker.SWFStatsTest.com/");
			Security.loadPolicyFile("http://tracker.SWFStatsTest.com/crossdomain.xml");
						
			Security.allowDomain("http://utils.SWFStatsTest.com/");
			Security.allowInsecureDomain("http://utils.SWFStatsTest.com/");
			Security.loadPolicyFile("http://utils.SWFStatsTest.com/crossdomain.xml");
		...
		// ------------------------------------------------------------------------------
		private static function Send(s:String):void
		{
			Request.Queue(s);
		...
		{
			var cookie:SharedObject = SharedObject.getLocal("SWFStatsTest");		
