package SWFStatsTest
{
	...
	public class HighScores
	{
		...
		{
			Log.Output("SWFStatsTest.HighScores.List  GLOBAL: '" + global + "', TABLE '" + table + "', MODE '" + mode + "', CALLBACK '" + callback + "'");
			...
			sendaction.load(new URLRequest("http://utils.SWFStatsTest.com/leaderboards/get.aspx?guid=" + Log.GUID + "&swfid=" + Log.SWFID + "&url=" + (global || Log.SourceUrl == null ? "global" : Log.SourceUrl) + "&table=" + table + "&mode=" + mode + "&" + Math.random()));
			
			trace("http://utils.SWFStatsTest.com/leaderboards/get.aspx?guid=" + Log.GUID + "&swfid=" + Log.SWFID + "&url=" + (global || Log.SourceUrl == null ? "global" : Log.SourceUrl) + "&table=" + table + "&" + Math.random());
		}

		public static function FacebookScores(table:String, callback:Function, friendlist:Array = null, mode:String = "alltime"):void
		{
			Log.Output("SWFStatsTest.HighScores.ListFacebook  TABLE '" + table + "', CALLBACK '" + callback + "', FRIENDSLIST '" + (friendlist != null ? friendlist.join(",") : "") + ", MODE '" + mode + "'");
			...
			sendaction.addEventListener(HTTPStatusEvent.HTTP_STATUS, StatusChange);
			sendaction.addEventListener(SecurityErrorEvent.SECURITY_ERROR, ScoresError);
			sendaction.load(new URLRequest("http://utils.SWFStatsTest.com/leaderboards/getfb.aspx?guid=" + Log.GUID + "&swfid=" + Log.SWFID + "&table=" + table + "&friendlist=" + (friendlist != null ? friendlist.join(",") : "") + "&mode=" + mode + "&" + Math.random()));
		}
		...
		{
			Log.Output("SWFStatsTest.HighScores.Submit  NAME '" + name + "', SCORE " + score + ", TABLE '" + table + "', FACEBOOK '" + facebook + "'");
			...
			sendaction.addEventListener(HTTPStatusEvent.HTTP_STATUS, StatusChange);
			sendaction.addEventListener(SecurityErrorEvent.SECURITY_ERROR, ScoresError);
			sendaction.load(new URLRequest("http://utils.SWFStatsTest.com/leaderboards/save.aspx?guid=" + Log.GUID + "&swfid=" + Log.SWFID + "&url=" + Log.SourceUrl + "&table=" + table + "&name=" + name + "&score=" + score + "&auth=" + MD5(Log.SourceUrl + score.toString()) + "&fb=" + (facebook ? "1" : "0") + "&r=" + Math.random()));
		}
		...
		{
			Log.Output("SWFStatsTest.HighScores.ScoresFinished");	
		...
		{
			Log.Output("SWFStatsTest.HighScores.ScoresError");	
			ScoresCallback(null);
			ScoresCallback = null;
		}
		...
		{
			Log.Output("SWFStatsTest.HighScores.FacebookScoresFinished");	
		...
		{
			Log.Output("SWFStatsTest.HighScores.FacebookScoresError");	
			FacebookScoresCallback(null);
			FacebookScoresCallback = null;
		}
		...
		{
			Log.Output("SWFStatsTest.HighScores.SubmitFinished");	
		...
		{
			Log.Output("SWFStatsTest.HighScores.SubmitError");	
		...
		{
			Log.Output("SWFStatsTest.HighScores.ProcessScores");	
