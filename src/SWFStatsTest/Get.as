package SWFStatsTest
{
	...
	public final class Get
	{
		...
		{
			Log.Output("SWFStatsTest.Get.General  TYPE '" + type + "' CALLBACK '" + callback + "' DAY '" + day + "' MONTH '" + month + "' YEAR '" + year + "'");
			...
			get.Loader.load(new URLRequest("http://utils.SWFStatsTest.com/data/" + type + ".aspx?swfid=" + Log.SWFID + "&guid=" + Log.GUID + "&day=" + day + "&month=" + month + "&year=" + year + "&" + Random));
		}

		public static function Goal(goalname:String, callback:Function, day:int=0, month:int=0, year:int=0):void
		{
			Log.Output("SWFStatsTest.Get.Goal  GOALNAME '" + goalname + "' CALLBACK '" + callback + "' DAY '" + day + "' MONTH '" + month + "' YEAR '" + year + "'");
			...
			get.Loader.addEventListener(HTTPStatusEvent.HTTP_STATUS, StatusChange);
			get.Loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, ErrorHandler);
			get.Loader.load(new URLRequest("http://utils.SWFStatsTest.com/data/goal.aspx?swfid=" + Log.SWFID + "&guid=" + Log.GUID + "&goal=" + escape(goalname) + "&day=" + day + "&month=" + month + "&year=" + year + "&" + Random));
		}
		
		public static function CustomMetric(metric:String, callback:Function, day:int=0, month:int=0, year:int=0):void
		{
			Log.Output("SWFStatsTest.Get.CustomMetric  METRIC '" + metric + "' CALLBACK '" + callback + "' DAY '" + day + "' MONTH '" + month + "' YEAR '" + year + "'");
			...
			get.Loader.addEventListener(HTTPStatusEvent.HTTP_STATUS, StatusChange);
			get.Loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, ErrorHandler);
			get.Loader.load(new URLRequest("http://utils.SWFStatsTest.com/data/custommetric.aspx?swfid=" + Log.SWFID + "&guid=" + Log.GUID + "&metric=" + escape(metric) + "&day=" + day + "&month=" + month + "&year=" + year + "&" + Random));
		}
		
		public static function LevelMetricCounter(metric:String, level:*, callback:Function, day:int=0, month:int=0, year:int=0):void
		{
			Log.Output("SWFStatsTest.Get.LevelMetricCounter  METRIC '" + metric + "' LEVEL '" + level + "' CALLBACK '" + callback + "' DAY '" + day + "' MONTH '" + month + "' YEAR '" + year + "'");			
		...
		{
			Log.Output("SWFStatsTest.Get.LevelMetricRanged  METRIC '" + metric + "' LEVEL '" + level + "' CALLBACK '" + callback + "' DAY '" + day + "' MONTH '" + month + "' YEAR '" + year + "'");						
		...
		{
			Log.Output("SWFStatsTest.Get.LevelMetricAverage  METRIC '" + metric + "' LEVEL '" + level + "' CALLBACK '" + callback + "' DAY '" + day + "' MONTH '" + month + "' YEAR '" + year + "'");						
		...
		private static function LevelMetric(type:String, mode:int, metric:String, level:*, callback:Function, day:int=0, month:int=0, year:int=0):void
		{
			...
			get.Loader.addEventListener(HTTPStatusEvent.HTTP_STATUS, StatusChange);
			get.Loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, ErrorHandler);
			get.Loader.load(new URLRequest("http://utils.SWFStatsTest.com/data/levelmetric" + type + ".aspx?swfid=" + Log.SWFID + "&guid=" + Log.GUID + "&metric=" + escape(metric) + "&level=" + level + "&day=" + day + "&month=" + month + "&year=" + year + "&" + Random));
		}
		...
		{
			Log.Output("SWFStatsTest.Get.ProcessData");	
		...
		{
			Log.Output("** ERROR COMPLETING REQUEST ~ SWFStatsTest.Get **");
		}
